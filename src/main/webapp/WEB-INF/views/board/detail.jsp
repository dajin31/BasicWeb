...
<body>
	<div class="container">
		<div class="form-floating mb-3">
			<input type="text" name="id" id="boardId" value="${board.id}"
				class="form-control"> <label for="boardId">게시글 아이디:</label>
		</div>
		<div class="form-floating mb-3">
	...
	//이걸만들어서 댓글 남기면 화면새로고침이 안되고 등록만 바로하게한,ㄴ것임. ajax방식
	  //결과를 방금 등록한 댓글만 응답받게 한다.
	...
	commentUpdateBtns.forEach(item=>{
		item.addEventListener("click",(ev)=>{
			...
			parent.innerHTML=`<div class="input-group">
								...
								<span>
									<button style="height: 80px" type="button" id="updateBtn" class="btn btn-info-0 ">등록</button>
								</span>
								<span>
